    ...
    <div className="container py-6">
      ...
      <Tabs defaultValue="account">
        ...
        <TabsContent value="billing">
          <Card className="glass-card glow glow-purple glass-highlight hover-float">
            <CardHeader>
              <CardTitle className="text-gradient-heading">SaaS Subscription & Platform Partnerships</CardTitle>
              <CardDescription>View your SaaS pricing tier, AMFI ARN Registry, broker referrals, and academy courses</CardDescription>
            </CardHeader>
            <CardContent>
              <SaasBilling user={user} />
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
