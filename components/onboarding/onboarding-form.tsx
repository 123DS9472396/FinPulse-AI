  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (dbError && dbError.code === '23505') {
        ...
        dbError = updateError
      } else if (dbError && (dbError.code === '42P01' || dbError.message.includes('does not exist'))) {
        setError("Table does not exist. Please run the setup SQL script in your Supabase dashboard.")
        setIsLoading(false)
        return
      }
